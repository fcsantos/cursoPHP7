...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/admin-lte/2.3.8/css/skins/skin-blue.min.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="res/admin/index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Dashboard</b>Ecommerce</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Olá, <?php echo getUserName(); ?></span>
            </a>
            <ul class="dropdown-menu">
